...
export class Level2 extends Phaser.Scene{
    ...
    preload () {
          ...
          this.load.image('ship2', 'https://examples.phaser.io/assets/sprites/shmup-ship2.png');
          this.load.image('backgrnd2', 'https://examples.phaser.io/assets/textures/cyberglow.png');
...
update (time, delta) {
    ...
    if (cursors.shift.isDown && time > lastFired2 && !endGame){
